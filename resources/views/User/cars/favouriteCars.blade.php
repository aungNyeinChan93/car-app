@extends('layouts.app', ['cssClass' => 'favourite cars'])

@section('title', 'favourite-cars')
...
@section('content')
    ...
    <main>
        ...
        <section>
            <div class="container">
                <h2 class="text-2xl font-bold py-2">My Favourite Cars</h2>
                <div class="car-items-listing">
                    @foreach ($myFavCars as $favCar)
                        <div class="car-item card">
                            ...
                            <div class="p-medium">
                                <div class="flex items-center justify-between">
                                    <small class="m-0 text-muted">{{ $favCar->name }}</small>
                                ...
                                <h2 class="car-item-title">{{ $favCar->models->name }}-
                                    {{ $favCar->maker->name }} || {{ $favCar->models->maker->name }}</h2>
