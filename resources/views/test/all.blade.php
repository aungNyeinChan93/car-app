...
<body>
    <main>
        <div class=" grid grid-cols-4 ">
            <div class="col-span-2 col-start-2 mt-[150px]">
                <div
                    class=" mx-auto w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
